          ...
          <div className="footer-col">
            ...
            <div className="footer-programs">
              ...
              <ul className="footer-list">
                <li><strong>Culte du Dimanche :</strong> 8h30</li>
                <li><strong>Culte de la Semaine :</strong> Mardi et Jeudi à 17h30</li>
          ...
          <div className="footer-col">
            ...
            <ul className="footer-list footer-contact">
              ...
              <li>
                ...
                <span>+243 999 949 822 (WhatsApp)</span>
              </li>
            </ul>
